...
export class LineChart extends SerialChart {
    ...
    processGraphicatorConfig() {
        ...
        this.config.c3Config.axis.y.min = minYValue; // truncating y axis
        if (minYValue > 0) this.config.c3Config.grid.y.lines[0].value = minYValue; // draw horizontal line at botoom
